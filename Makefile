...
SRCS	= cub3d.c \
		...
		src/cast_to_3d.c src/mouse_press.c src/key_press.c src/mouse_move.c src/render_game.c src/mouse_release.c src/map_animation.c src/design_env.c src/init_multi_imgs.c
